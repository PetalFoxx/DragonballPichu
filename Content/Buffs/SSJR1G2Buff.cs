...
{
    public class SSJR1G2Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJR1G2";
        ...
        public static new readonly string UnlockHint = "Such an innocent idea, yet so superfluous";
