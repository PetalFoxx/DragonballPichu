...
{
    public class SSJB1G4Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJB1G4";
        ...
        public static new readonly string UnlockHint = "Even godly power can be honed to a sharp edge";
