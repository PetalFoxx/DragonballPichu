...
{
    public class LSSJ3Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "LSSJ3";
        ...
        public static new readonly string UnlockHint = "Rip those tendrills out of that sidewalk-weed!";
