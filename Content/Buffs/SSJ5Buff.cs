...
{
    public class SSJ5Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJ5";
        ...
        public static new readonly string UnlockHint = "I will not let you destroy my world!";
