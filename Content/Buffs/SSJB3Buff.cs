...
{
    public class SSJB3Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJB3";
        ...
        public static new readonly string UnlockHint = "The pinnacle of this godly state... this is true power!";
