...
{
    public class FSSJBBuff : TransformationBuff
    {
        ...
        public static new readonly string name = "FSSJB";
        public static new readonly Boolean isStackable = false;
        public static new readonly List<string> special = new List<string>() { "Ki Power", "0.8-1" };
        public static new readonly string UnlockHint = "Fighting a god as a god may yield to an inexperienced ascension";
