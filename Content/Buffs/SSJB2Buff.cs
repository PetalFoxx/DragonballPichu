...
{
    public class SSJB2Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJB2";
        ...
        public static new readonly string UnlockHint = "This is the true ascension of a godly super saiyan";
