...
{
    public class SSJ7Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJ7";
        ...
        public static new readonly string UnlockHint = "Now, you have reached the pinnacle of your potential";
