...
{
    public class SSJB1G2Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJB1G2";
        ...
        public static new readonly string UnlockHint = "Even godly power can be hammered into a dense, but dull blade";
