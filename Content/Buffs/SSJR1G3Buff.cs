...
{
    public class SSJR1G3Buff : TransformationBuff
    {
        ...
        public static new readonly string name = "SSJR1G3";
        ...
        public static new readonly string UnlockHint = "Perhaps taking it even further could bring... results?";
