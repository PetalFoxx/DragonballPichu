...
namespace DragonballPichu.Content.Buffs
{
    public class SSJ1G4Buff : TransformationBuff
    {
        ...
        public static new readonly string UnlockHint = "Abandon power; seek sustainability";
